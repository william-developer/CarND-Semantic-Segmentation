...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
  ...
  # Upsampling x 4
  upsampling1 = tf.layers.conv2d_transpose(conv_1x1_layer7,
                                           num_classes,
                                           4,
                                           2,
                                           padding='same',
...
def run():
  ...
  with tf.Session() as sess:
    ...
    input_layer, keep_prob_tensor, layer3, layer4, layer7 = load_vgg(sess,
                                                                     vgg_path)
    nn_last_layer = layers(layer3, layer4, layer7, num_classes)

    # Placeholders
    correct_label_tensor = tf.placeholder(tf.int32,
